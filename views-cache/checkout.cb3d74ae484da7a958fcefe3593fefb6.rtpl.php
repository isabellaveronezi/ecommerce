									...
									<div class="woocommerce-billing-fields">
										...
										<div id="order_review" style="position: relative;">
											...
											data-o_class="form-row form-row-first address-field validate-state">
												<input type="radio" checked="checked" id="method-pagseguro" name="payment-method" 
												placeholder="Estado" value="1" style="float:left; margin: 30px;">
											...
											data-o_class="form-row form-row-first address-field validate-state">
												...
												placeholder="Estado" value="2" style="float:left; margin: 30px;">
												<label class = "" for="method-paypal"><img style="height:64px;" src="/res/site/img/logo-paypal.png"></label>
											</p>
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" 
											data-o_class="form-row form-row-first address-field validate-state">
												<input type="radio" id="method-boleto" name="payment-method" 
												placeholder="Estado" value="3" style="float:left; margin: 30px;">
												<label class = "" for="method-boleto"><img style="height:54px;" src="/res/site/img/itau-logo.jpg"></label>
											</p>
											<div id="payment">
